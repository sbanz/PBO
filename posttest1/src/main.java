            ...
            switch(pilih){
                ...
                case 2 :
                    ...
                    for(int idx = 0; idx < dataklub.size(); idx++){
                        ...
                        System.out.println("Club Name : "+dataklub.get(idx).clname);
                        System.out.println("Home Stadium : "+dataklub.get(idx).clstadium);
                        System.out.println("Total Player : "+dataklub.get(idx).playerttl);
                        System.out.print("\n");
                    }
                    confirm();
                    cls();
                ...
                case 3 :
                    ...
                    if(idxx > 0 && idxx <= dataklub.size()){
                        ...
                        System.out.println("Input Club Name : ");
                        String new_cl_name = br.readLine();
                        System.out.println("Input Home Stadium : ");
                        String new_cl_stad = br.readLine();
                        System.out.println("Input Total Player : ");
                        int new_ttl_ply = Integer.parseInt(br.readLine());
                        dataklub.set(idxx -1, (new data_klub(new_cl_name, new_cl_stad, new_ttl_ply)));
