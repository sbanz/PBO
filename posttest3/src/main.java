                ...
                case 1 :
                    ...
                    switch(pilih_create){
                        case 1 :
                            ...
                            ft.add(new first_team(cl_name_ft, cl_stad_ft, hometown_ft, ttl_player_ft));
                        ...
                        case 2 :
                            ...
                            pl2.add(new pl2(cl_name_pl2, cl_stad_pl2, hometown_pl2, ttl_player_pl2));
                            System.out.println("Data added.");
                            confirm();
                            cls();
                            break;
                        ...
                        case 3 :
                            ...
                            u18.add(new u18(cl_name_u18, cl_stad_u18, hometown_u18, ttl_player_u18));
                            System.out.println("Data added.");
                            confirm();
                            cls();
                            break;
